...
def create_database():
    ...
    cursor.execute(
        "CREATE INDEX IF NOT EXISTS idx_latitude_longitude ON scraped_locations(latitude, longitude)"
    )
    cursor.execute(
        "CREATE INDEX IF NOT EXISTS idx_extracted_name ON scraped_locations(extracted_name)"
    )
    cursor.execute(
        "CREATE INDEX IF NOT EXISTS idx_unique_spots_coords ON unique_spots(latitude, longitude)"
    )
