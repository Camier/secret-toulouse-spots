...
TOURISM_SITES = [
    {
        ...
        'search_paths': ['/en/discover/secret-toulouse', '/fr/decouvrir/toulouse-insolite']
    },
    {
...
HIDDEN_KEYWORDS = [
    'secret', 'caché', 'méconnu', 'insolite', 'hors des sentiers battus',
    'peu connu', 'confidentiel', 'hidden', 'off the beaten path', 'insider',
    'locals only', 'best kept secret', 'undiscovered', 'unknown'
]
...
def convert_to_spot_format(tourism_spot):
    ...
    is_hidden = any(keyword in tourism_spot['description'].lower() 
